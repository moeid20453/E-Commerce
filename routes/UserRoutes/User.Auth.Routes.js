...
const { addUserValidation, confirmPasswordVlidation} = require('../../validation/User.Validation')
...
const {register, login,logout,activateUser, updateUser} = require('../../controllers/Client/Index.controller')
